...
ifstream level4Read("stage4.in");
ifstream level5Read("stage5.in");
ifstream level6Read("stage6.in");
...
/*-------------------------------------------------------------------------------*/
    ...
    backgroundTex2.loadFromFile("assets/images/background_final2.png");
   ...
   textGreen.scale(0.5f, 0.5f);
    ...
    spriteBackground2.setTexture(backgroundTex2);
    spriteBackground3.setTexture(backgroundTex);
    spriteBackground4.setTexture(backgroundTex2);
                     ...
                     if(menuSelection == 3)
                        {
                            if(totalProgress > 2){
                                levelSelection = 4;
                                view.zoom(1.0f/gameScale);
                            cout<<"Nivel selectat: 4"<<endl<<endl;
                                menuSelection = 1;
                     ...
                     if(menuSelection == 3)
                        {
                            if(totalProgress > 2){
                                levelSelection = 5;
                                view.zoom(1.0f/gameScale);
                            cout<<"Nivel selectat: 5"<<endl<<endl;
                                menuSelection = 1;
                     ...
                     if(menuSelection == 3)
                        {
                            if(totalProgress > 2){
                                levelSelection = 6;
                                view.zoom(1.0f/gameScale);
                            cout<<"Nivel selectat: 6"<<endl<<endl;
                                menuSelection = 1;
...
/*-------------------------------------------------------------------------------*/
        ...
        totalProgress ++;
         ...
         levelIsLoaded = false;
            window.clear();
                  ...
                  view.setCenter(player.getPosition().x + player.size.x /2 + halfWinWidth/2, player.getPosition().y + player.size.y /2);
 ...
 if(isLevelDrawn == true && menuSelection == 1 )
    ...
    if(isFinished == 0)
        ...
        view.setCenter(player.getPosition().x + player.size.x /2 +  halfWinWidth/1.35f, player.getPosition().y + player.size.y /2 );
    window.setView(view);
